...
object LevelLoadingScreenMixinLogic {
    fun hookRenderLogic(matrices: MatrixStack, progressProvider: WorldGenerationProgressTracker, width: Int, height: Int, textRenderer: TextRenderer) {
        ...
        DrawableHelper.drawCenteredTextWithShadow(matrices, textRenderer, "Generating level", i, j + 15, LegacyDisplay.TEXT_COLOR)
        DrawableHelper.drawCenteredTextWithShadow(matrices, textRenderer, "Building terrain", i, j + 39, LegacyDisplay.TEXT_COLOR)
